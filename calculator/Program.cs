...
namespace calculator
{
    class Program
    {
        ...
        {
            GetOperationFromUser("Operation: ");
        ...
        static string GetOperationFromUser(string question)
        {
            bool sym = false;
            string symbol = "";
            ...
            while (!sym)
            {
                Console.Write(question);
                string oper = Console.ReadLine();
                sym = string.Equals(question, symbol);
                ...
                else if (oper == "m" || oper == "M" || oper == "d" || oper == "D")
                {
                    Console.Write("Repeat letter: ");
                    switch (Console.ReadKey().Key)
                    {
                        case ConsoleKey.M:
                            Console.ReadLine();
